...
describe('getHighwatermark', () => {
  it('should return options.override if it is set', function*() {
    const highwatermark = yield appuriHighwatermark.getHighwatermark('', '', { override: 'override', default: 'default' })
  ...
  it('should return the options.default if there is no high watermark in s3', function*() {
    ...
    const highwatermark = yield mockedAppuriHighwatermark.getHighwatermark('bucket', 'key', { default: 'default' })
  ...
  it('should return the value from s3', function*() {
    ...
    const highwatermark = yield mockedAppuriHighwatermark.getHighwatermark('bucket', 'key')
  ...
  it('should throw if options.isValid is set and the highwatermark is invalid', function*() {
    try {
      yield appuriHighwatermark.getHighwatermark('bucket', 'key', { override: 'foo', isValid: () => false })
  ...
  it('should map the highwatermark if options.map is set', function*() {
    ...
    const highwatermark = yield appuriHighwatermark.getHighwatermark('bucket', 'key', {
      override: '123',
...
describe('putHighwatermark', () => {
  ...
  it('should send the highwatermark back to s3', function*() {
    ...
    yield mockedAppuriHighwatermark.putHighwatermark('bucket', 'key', 'new_highwatermark')
    called.should.equal(1)
  })
